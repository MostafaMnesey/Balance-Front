          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 ">
              <div className="">
                ...
                <p className="text-white text-[18px] font-normal font-roboto md:pe-28 my-5">
                  Have questions or need support? Whether you’re looking to join
                  Balance or just want to learn more, we’d love to hear from
        ...
        <div className="form min-h-[20vh] my-10 bg-white">
          <div className="container mx-auto ">
            <form action="" className="mb-20">
              ...
              <label
                for="message"
                class="block mb-2 text-sm font-medium mx-3 md:mx-0 text-secondColor font-roboto dark:text-white"
              >
                Your message
              </label>
              <textarea
                id="message"
                rows="4"
                class="block max-h-52  min-h-36 shadow-xl w-11/12 place-self-center md:w-full  text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-mainColor focus:border-mainColor dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
